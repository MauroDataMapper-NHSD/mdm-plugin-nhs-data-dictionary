...
*/
    ...
    DataModel toCatalogueItem(DataDictionary dataDictionary) {
        ...
        if (label.startsWith("CDS")) {
            CDSDataSetParser.parseCDSDataSet((GPathResult) definition, catalogueItem, dataDictionary)
        } else {
            DataSetParser.parseDataSet((GPathResult) definition, catalogueItem, dataDictionary)
        }
